...
**Risk-Adjusted Feasibility: 0.50 / 1.00 (Moderate)**  
Opportunity 0.69 × (1 − Combined Risk 0.28) = 0.50  *(tenant: hyperscaler)*
...
| --- | --- | --- | --- |
| regulatory_interconnection_pause | regulatory | 0.28 | Delmarva Power: DE PSC 25-0826 active interconnection pause (expected lift 2026-12-31, ~8.2 months out) |
