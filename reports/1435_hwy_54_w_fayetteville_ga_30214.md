...
## Executive Summary
**Overall Site Rating: 3.6 / 5.0 (Moderate)**

Highest voltage line: 500.0 kV (500) at 9.2 km, owned by GEORGIA POWER CO. Estimated grid capacity without major upgrades: ~800 MW. Connecting substations: UNION to O'HARA.
...
| --- | --- | --- | --- | --- |
| 500 | 500 kV | 9.2 | GEORGIA POWER CO | UNION - O'HARA |
| 220-287 | 230 kV | 4.9 | GEORGIA POWER CO | UNKNOWN116410 - UNKNOWN116411 |
| 100-161 | 115 kV | 6.5 | GEORGIA POWER CO | UNKNOWN116360 - UNKNOWN116361 |
| UNDER 100 | UNDER 100 | 20.2 | GEORGIA POWER CO | UNKNOWN116335 - UNKNOWN116336 |
| NOT AVAILABLE | NOT AVAILABLE | 16.3 | GEORGIA POWER CO | UNKNOWN113562 - UNKNOWN116038 |
...
### Georgia Power -- Special Contract Authority
- **Type:** dc_specific
- **Status:** approved
- **Min Demand:** 100 MW
- **Contract Term:** 15 years
- **Min Billing:** None%
- **Collateral:** Can charge for upstream generation, transmission, and distribution costs
- **Exit Fees:** Per negotiated contract terms; PSC review required
...
- **Census Tract:** 13113140204
- **Diesel PM Percentile:** 0.52
- **PM2.5 Percentile:** 0.64
- **Low Income Percentile:** 0.49
- **Housing Burden Percentile:** 0.18

### Seismic Hazard: **SDC B** (Low)
- **Peak Ground Acceleration:** 0.110g
- **Ss (short-period):** 0.22g | **S1 (1-sec):** 0.09g
- Standard construction practices adequate.

### Climate & Land Cost
- **Cooling Degree Days:** 1,981 (Warm (higher cooling costs))
...
| QTS FAYETTEVILLE I, LLC | QTS FAYETTEVILLE I,  | TBD |  | 1.4 |
| GOOGLE LLC | GOOGLE LLC | TBD |  | 12.5 |
| MICROSOFT DATA CENTER (CCO06) | MICROSOFT DATA CENTE | TBD |  | 13.1 |
| VANTAGE DATA CENTERS GA 11 | VANTAGE DATA CENTERS | TBD |  | 17.8 |
| ATL11 | ATL11 | TBD |  | 20.2 |
| VANTAGE DATA CENTERS GA2, LLC | VANTAGE DATA CENTERS | TBD |  | 29.6 |
| T5@ATLANTA III, LLC | T5@ATLANTA III, LLC | TBD |  | 30.4 |
| ALIGNED DATA CENTERS ATL01 | ALIGNED DATA CENTERS | TBD |  | 32.3 |
| FLEXENTIAL CORPORATION | FLEXENTIAL CORPORATI | TBD |  | 32.8 |
| DCB ATLANTA WEST, LLC | DCB ATLANTA WEST, LL | TBD |  | 33.1 |
| DB DATA CENTER BOULDER PARK, LLC | DB DATA CENTER BOULD | TBD |  | 33.6 |
| GOOGLE, LLC | GOOGLE, LLC | TBD |  | 33.9 |
| AMAZON DATA SERVICES, INC. ATL068 AND AT | AMAZON DATA SERVICES | TBD |  | 36.1 |
| DATA CENTER FULTON, LLC | DATA CENTER FULTON,  | TBD |  | 36.4 |
...
| DC Tariff Risk | [++++-] | 4/5 | 15% |


**Weighted Total: 3.6 / 5.0**
